...
//            print("Nem prím")
       ...
       // System.out.printf("%d és %d között ",also, felso);
        ...
        //static csak staticot lát, static=osztályhoz tartozik//
        //ha a main-ből szeretnénk valamit elérni, akkor staticnak kell lennie//
        if (van){
            kimenet += "Van 0-ra végződő szám: " + i;
            db=i-also+1;
            kimenet += "\n Össszesen %d db számot vizsgáltam ".formatted(db);
